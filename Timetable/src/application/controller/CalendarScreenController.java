...
public class CalendarScreenController implements EventHandler<ActionEvent>
{
	...
	@FXML
	private Circle w1d1Circ, w1d2Circ, w1d3Circ, w1d4Circ, w1d5Circ, w1d6Circ, w1d7Circ;
	@FXML
	private Circle w2d1Circ, w2d2Circ, w2d3Circ, w2d4Circ, w2d5Circ, w2d6Circ, w2d7Circ;
	@FXML
	private Circle w3d1Circ, w3d2Circ, w3d3Circ, w3d4Circ, w3d5Circ, w3d6Circ, w3d7Circ;
	@FXML
	private Circle w4d1Circ, w4d2Circ, w4d3Circ, w4d4Circ, w4d5Circ, w4d6Circ, w4d7Circ;
	@FXML
	private Circle w5d1Circ, w5d2Circ, w5d3Circ, w5d4Circ, w5d5Circ, w5d6Circ, w5d7Circ;
	@FXML
	private Circle w6d1Circ, w6d2Circ;
	
	// These are the date labels themselves:
	@FXML
	private Label w1d1, w1d2, w1d3, w1d4, w1d5, w1d6, w1d7; 
	@FXML
	private Label w2d1, w2d2, w2d3, w2d4, w2d5, w2d6, w2d7;
	@FXML
	private Label w3d1, w3d2, w3d3, w3d4, w3d5, w3d6, w3d7;
	@FXML
	private Label w4d1, w4d2, w4d3, w4d4, w4d5, w4d6, w4d7;
	@FXML
	private Label w5d1, w5d2, w5d3, w5d4, w5d5, w5d6, w5d7;
	@FXML
	private Label w6d1, w6d2;
